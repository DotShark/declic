      ...
      >
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          <div class="flex flex-col gap-3">
            ...
            >
              <span v-if="mailStore.isSending" class="flex items-center justify-center gap-2">
          ...
          >
            <p 
              ...
              :class="mailStore.statusMessage.includes('Échec') ? 'text-red-600 bg-red-50' : 'text-emerald-700 bg-emerald-50'"
              role="status"
            >
